...
# Definir a variável 'tema' com algum valor ou função
tema = "darkgrid"  # Pode ser qualquer valor, como uma string ou um tema válido do seaborn

# Usar a variável tema
